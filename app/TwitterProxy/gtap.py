...
gtap_message = gtap_message + "<p>This is a simple solution on Google Appengine which can proxy the HTTP request to twitter's official REST API url.</p><p>Now You can:</p><p><strong>1</strong> use <i>https://#app_url#/</i> instead of <i>https://twitter.com/</i> <br /></p><p><strong>2</strong> use <i>https://#app_url#/api/</i> instead of <i>https://api.twitter.com/</i> <br /></p><p><strong>3</strong> use <i>https://#app_url#/search</i> instead of <i>https://search.twitter.com/</i> <br /></p><p><font color='red'><b>Don't forget the \"/\" at the end of your api proxy address!!!.</b></font></p></body></html>"
