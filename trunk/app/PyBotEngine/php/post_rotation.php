...
$file = "timer.txt";       //発言を書き込んだファイルの名前（変更可能）。サーバーにアップロードしたらパーミッションを666に設定してください。  
$end = "现在小sin的版本号还是0.1喔，请多多指教！"; //投稿をエンドレスにループさせたくない場合、一番最後の発言を書き込んでください。設定しないと（「$end ="";」にすると）エンドレスにループします。
//====================================================================
//設定終わり
//ここから下は編集しないでください
//====================================================================
